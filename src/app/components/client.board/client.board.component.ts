...
form!: FormGroup;
  ...
  responseMessage: string | null = null;
   ...
   constructor(private fb: FormBuilder, private router: Router, private clientServices: ClientServices,
    private localStorageServices : LocalStorageServices, private snackBar: MatSnackBar,
  ...
  editClient(row : any){
    const encryptedPatient = this.encryptionService.encryptToken(JSON.stringify(row));
